...
Poiché \$0\le p\_i(1-p\_i)\$, la matrice \(W\) è semidefinita positiva.
...
La hinge loss non è derivabile in \$1-y\_i\theta\^{}Tx\_i=0\$, ma è
convessa. Possiamo quindi usare il \textbf{sub-gradiente}.
